...
function[lik1, lik2, F, simA, simAFix, prob1, prob2, pptprob1, rew, u1, u2] = Model1_Gen(parms, data)
...
val1c = beta*max(s1-o1,0) ; 
val2c = beta*max(s2-o2,0) ;
u1(t)= val1c;
u2(t)= val2c;
...
val1ppt = beta*max(s1-o1,0) ; 
val2ppt = beta*max(s2-o2,0) ;
