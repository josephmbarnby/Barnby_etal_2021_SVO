...
function[lik1, lik2, F, simA, simAFix, prob1, prob2, pptprob1, rew, u1, u2, congCount, alpha_marg, beta_marg, alpha_marg2, beta_marg2] = Model5_Gen(parms, data)
...
subject_estimate_pchoose1Fix = (1./(1+exp(-(val1ppt - val2ppt))));
    ...
    if (subject_estimate == 1)
        ...
        prob2(t-18) = 1-subject_adjp1;
    end

simA(t)    = randsample([1,2],1,true,[subject_adjp1, 1-subject_adjp1]);
