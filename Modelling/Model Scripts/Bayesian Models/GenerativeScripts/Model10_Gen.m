...
function[lik1, lik2, F, simA, simAFix, prob1, prob2, pptprob1, rew, u1, u2, congCount, alpha_marg, beta_marg, alpha_marg2, beta_marg2] = Model10_Gen(parms, data)
...
alpha           = 15*(1./(1+exp(-alpha_raw))); % restrict alpha to between 0 and res
...
alpha_null = parms(5);
alpha_null = 15*(1./(1+exp(-alpha_null))); % restrict alpha to between 0 and 15
beta_null  = parms(6);
