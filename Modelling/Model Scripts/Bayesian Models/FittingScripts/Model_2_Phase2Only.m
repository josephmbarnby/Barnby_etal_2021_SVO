...
function[F] = Model_2_Phase2Only(parms, data)

   % Initialise
   
      res = 15; % resolution of grid 
...
% how the experimenter learns how the subject learns 
% online about the partner in phase 2
